...
export const stockInSchema = yup
  .object({
    products: yup
      .array()
      .of(
        yup.object({
          ...
          limit: yup
            .number()
            .optional()
            .min(1, 'Limit cannot be zero or negative'),
        })
      )
...
export const stockOutSchema = yup
  .object({
    products: yup
      .array()
      .of(
...
export const adjustmentSchema = yup
  .object({
    products: yup
      .array()
      .of(
...
export type StockInBody = yup.InferType<typeof stockInSchema>;
export type StockOutBody = yup.InferType<typeof stockOutSchema>;
export type AdjustmentBody = yup.InferType<typeof adjustmentSchema>;
export type TransferBody = yup.InferType<typeof transferSchema>;
